from src.ingest.table_extractors.earnings_reports.family_1_er import extract_earnings_report_tables_family_1
from src.ingest.table_extractors.earnings_reports.family_2_er import extract_earnings_report_tables_family_2
from src.ingest.table_extractors.earnings_reports.family_3_er import extract_earnings_report_tables_family_3
from src.ingest.table_extractors.earnings_reports.family_4_er import extract_earnings_report_tables_family_4
from src.ingest.table_extractors.earnings_reports.family_5_er import extract_earnings_report_tables_family_5
from src.ingest.table_extractors.earnings_reports.family_6_er import extract_earnings_report_tables_family_6
